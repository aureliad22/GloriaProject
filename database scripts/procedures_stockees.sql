...
CREATE PROCEDURE [dbo].[LIST_TESTS]
...
-- Description:	Stored procedure that inserts a new answer 
-- with the given parameters into the database
-- and returns the autogenerated id.
-- =============================================
CREATE PROCEDURE [dbo].[ADD_ANSWER]
    @idQuestion int,
...
BEGIN
	...
	INSERT INTO reponses(idQuestion,enonce,estBonne)
    VALUES (@idQuestion, @enonce,@estBonne)
...
CREATE PROCEDURE [dbo].[ADD_THEME_QUESTION]
...
BEGIN
    ...
    insert into themes_questions(idTheme,idQuestion) values (
	@idTheme,
	@idQuestion)
