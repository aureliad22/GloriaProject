...
-- Create date: 01/08/2017
-- Description: Stocked procedure that updates the candidate
-- with the given id.
-- =============================================
...
-- Description: Stocked procedure that returns the list of the tests
...
-- Author:      GloriaProject
-- Create date: 04/08/2017
-- Description: Stocked procedure that returns the list 
...
-- Author:      GloriaProject
-- Create date: 04/08/2017
-- Description: Stocked procedure that returns the list of questions
...
-- Author:      GloriaProject
-- Create date: 04/08/2017
-- Description: Stocked procedure that returns the list of answers
